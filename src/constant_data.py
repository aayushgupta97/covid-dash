...
country_with_codes = [{'label': 'Afghanistan', 'value': 'AF'},
...
#185
currently_present_in_api_country = [{'label': 'Afghanistan', 'value': 'AF'},
 {'label': 'Albania', 'value': 'AL'},
 {'label': 'Algeria', 'value': 'DZ'},
 {'label': 'AndorrA', 'value': 'AD'},
 {'label': 'Angola', 'value': 'AO'},
...
indian_state_with_codes = []

country_code_to_name = {'AF': 'Afghanistan', 'AL': 'Albania', 'DZ': 
'Algeria', 'AD': 'AndorrA', 
...
'LV': 'Latvia', 'LB': 'Lebanon', 'LR': 'Liberia',
...
'MX': 'Mexico', 'MD': 'Moldova, Republic of',
...
'SI': 'Slovenia', 'SO': 'Somalia',
'ZA': 'South Africa', 'ES': 'Spain', 
'LK': 'Sri Lanka', 'SD': 'Sudan', 
'SR': 'Suri"name"', 'SZ': 'Swaziland',
...
'VN': 'Viet Nam', 'EH': 'Western Sahara', 
'YE': 'Yemen', 'ZM': 'Zambia',
'ZW': 'Zimbabwe', 'ME': 'Montenegro', 
'DP': 'Diamond Princess', 'RS': 'Serbia', 'SS': 'South Sudan'}